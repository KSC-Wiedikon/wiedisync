export default {
  ...
  mailboxGroupPlaceholder: 'Gruppe uswähle…',
  mailboxGroupTeams: 'Teams',
  ...
  mailboxGroup_sport_volleyball: 'Alli Volleyball',
  mailboxGroup_sport_basketball: 'Alli Basketball',
