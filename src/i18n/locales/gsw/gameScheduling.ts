export default {
  ...
  mailboxGroup_all: 'Alli Mitglieder',
  mailboxGroup_sport_volleyball: 'Volleyball-Spiler*inne',
  mailboxGroup_sport_basketball: 'Basketball-Spiler*inne',
  mailboxGroup_fn_coach: 'Alli Trainer*inne',
  mailboxGroup_fn_team_responsible: 'Alli Teamverantwortliche',
  mailboxGroup_fn_captain: 'Alli Captains',
  mailboxGroup_qual_scorer_vb: 'Alli Schriiber*inne',
  mailboxGroup_qual_referee_vb: 'Alli Schiedsrichter*inne (Volleyball)',
  mailboxGroup_qual_referee_bb: 'Alli Schiedsrichter*inne (Basketball)',
  mailboxGroup_qual_officials_bb: 'Alli Offizielle (Basketball)',
  mailboxGroup_role_vorstand: 'Vorstand',
  mailboxSection_everyone: 'Alli',
