export default {
  ...
  federationOfOriginNone: 'Kene / nie im Usland lizenziert',
  federationOfOriginHint: 'De nationaal Verband, wo du zletscht lizenziert gsi bisch — bruuchts für d Spielberechtigung.',
