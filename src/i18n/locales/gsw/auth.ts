export default {
  ...
  federationOfOriginNone: 'Kene / mit 14 bi kem nationale Verband lizenziert',
  federationOfOriginHint: 'De nationaal Verband, wo di mit 14 lizenziert het — nöd zwingend det, wo du zerscht gspilt häsch.',
