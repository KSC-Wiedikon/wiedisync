export default {
  ...
  lastName: 'Nachname',
  nickname: 'Spitzname',
  nicknameHint: 'Wird i de App statt em Vorname azeigt. Läär la, zum de Vorname bruuche.',
  ...
  federationOfOriginHint: 'De nationaal Verband, wo di zerscht lizenziert het. Wenn das dini allererschti Lizenz isch, nimm d Schwiiz — denn isch Swiss Volley bzw. Swiss Basketball din Herkunftsverband.',
  nationalitaetHint: 'Mehrfachuswahl möglich.',
  trainerLicences: 'Trainerusbildig',
  trainerLicencesHint: 'Mehrfachuswahl möglich — J+S isch unabhängig vo de Trainerstuef.',
  ...
  invalidAhvFormat: 'AHV-Nummere isch ungültig — Format 756.XXXX.XXXX.XX mit gültiger Prüefziffere',
  invalidPhoneFormat: 'Bitte überprüef d Telefonnummere — die schiint ungültig z sii',
  ...
  idTitle: 'Uswiisdokumänt',
  idExplainer: 'Wird uf dim Grät verschlüsselt, bevor s das verlaht. Dini Trainer und Teamverantwortliche chönd s vor eme Spiel de Schiidsrichter zeige. Susch cha s niemert öffne — weder de Verein no d Admins no de Server.',
  idSetupHint: 'Gib eimal dis Passwort ii, zum din Schlüssel z erstelle. Er verlaht das Grät nie.',
  idUnlockHint: 'Gib dis Passwort ii, zum din Schlüssel uf dem Grät z entsperre.',
  idPasswordPlaceholder: 'Dis Passwort',
  idSetup: 'Schlüssel erstelle',
  idUnlock: 'Entsperre',
  idKeyCreated: 'Schlüssel erstellt',
  idKeyFailed: 'De Schlüssel het nöd chönne erstellt werde.',
  idUnlocked: 'Uf dem Grät entsperrt',
  idWrongPassword: 'Falsches Passwort.',
  idResetWarning: 'Wänn du dis Passwort zrugsetzsch, gaht din Schlüssel verlore und du muesch dis Dokumänt nomal ufelade.',
  idUpload: 'Dokumänt ufelade',
  idUploadHint: 'Es Foti vo dinere ID oder vo dim Pass. Max. 8 MB.',
  idReplace: 'Ersetze',
  idView: 'Dokumänt aazeige',
  idDelete: 'Lösche',
  idDeleteConfirm: 'Uswiisdokumänt lösche? Dini Trainer chönd s dänn nüme zeige.',
  idDeleted: 'Dokumänt glöscht',
  idDeleteFailed: 'S Dokumänt het nöd chönne glöscht werde.',
  idUploaded_one: 'Ufeglade und verschlüsselt. {{count}} Teamleitig cha s öffne.',
  idUploaded_other: 'Ufeglade und verschlüsselt. {{count}} Persone vo de Teamleitig chönd s öffne.',
  idGapTitle_one: '{{count}} Teamleitig cha dini ID no nöd öffne',
  idGapTitle_other: '{{count}} Persone vo de Teamleitig chönd dini ID no nöd öffne',
  idGapHint: '{{names}} isch erst nach dim Upload zur Teamleitig cho. Mit «Zuegriff gäh» wird das gflickt — dis Dokumänt wird nöd neu ufeglade und susch überchunnt niemert Zuegriff.',
  idGrant: 'Zuegriff gäh',
  idGranted_one: 'Zuegriff für {{count}} Teamleitig gäh.',
  idGranted_other: 'Zuegriff für {{count}} Persone vo de Teamleitig gäh.',
  idGrantFailed: 'De Zuegriff het nöd chönne gäh werde.',
  idUploadFailed: 'S Dokumänt het nöd chönne ufeglade werde.',
  idDecryptFailed: 'S Dokumänt het nöd chönne göffnet werde.',
  idTooLarge: 'D Datei isch z gross. Max. 8 MB.',
  idStored: 'Am {{date}} verschlüsselt gspeicheret.',
  ...
  // Zueschnide / drehe, bevor verschlüsslet wird
  idCropTitle: 'Dokumänt aapasse',
  idCropHint: 'Zum Verschiebe zieh, zum Zoome zwei Finger oder de Regler, wänn nötig drehe.',
  idCropZoom: 'Zoom',
  idCropRotateLeft: 'Nach links drehe',
  idCropRotateRight: 'Nach rächts drehe',
  idCropShape: 'Dokumäntformat',
  idCropAspect_card: 'Uswies',
  idCropAspect_landscape: 'Querformat',
  idCropAspect_portrait: 'Hochformat',
  idCropCancel: 'Abbräche',
  idCropConfirm: 'Das Foti bruche',
  idCropFailed: 'S Bild het nöd chönne verarbeitet werde. Probier bitte es anders Foti.',
