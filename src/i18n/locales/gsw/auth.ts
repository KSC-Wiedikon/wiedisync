export default {
  ...
  websiteNameOnly: 'Nur Vorname uf de Website zeige',
  websiteNameOnlyHint: 'Uf de öffentliche Vereinswebsite wird din Nachname nur als Initiale azeigt (z. B. «Anna M.») und din Jahrgang versteckt.',
  hidden: 'Versteckt',
