export default {
  ...
  expenseMineTitle: 'Mini Iireichige',
  expenseStatusCol: 'Status',
  expenseStatus_pending: 'Offe',
  expenseStatus_paid: 'Zahlt',
  expenseStatus_rejected: 'Abglehnt',
  expenseReceipt: 'Beleg',
  expenseMember: 'Mitglid',
  expenseFinanceNote: 'Notiz as Mitglid',
  expenseFinanceNoteHint: 'Für s Mitglid näbem Status sichtbar.',
  expenseInternalNote: 'Interni Notiz',
  expenseInternalNoteHint: 'Für Finanze, TK und Admin sichtbar. Nöd fürs Mitglid.',
  expenseInternalNotePlaceholder: 'Notiz für Finanze, TK und Admin …',
  expenseEdit: 'Bearbeite',
  expenseSave: 'Speichere',
  expenseCancel: 'Abbräche',
  expenseSaved: 'Gspeicheret.',
  expenseStatusUpdated: 'Status aktualisiert.',
  expenseUpdateError: 'Aktualisierig fehlgschlage — bitte nomal versueche.',
  expensePayoutCreated: 'Uszahlig fürs Mitglid erstellt.',
  expensePayoutSkipped: 'Kei Uszahlig erstellt: {{reason}}.',
  expensePayoutCancelled: 'Verknüpfti Uszahlig storniert.',
  expensePayoutSkip_NON_CHF: 'd Spese sind nöd i CHF',
  expensePayoutSkip_NO_IBAN: 'kei gültigi CH/LI-IBAN hinterleit',
  expensePayoutSkip_ADDRESS_INCOMPLETE: 'd Empfängeradräss isch unvollständig',
  expensePayoutSkip_FAILED: 'es het en Fähler gäh — bitte manuell erstelle',
  expenseConfirmPaid: 'Spese über {{amount}} vo {{member}} als zahlt markiere? S Mitglid wird benachrichtigt.',
  expenseConfirmRejected: 'Spese über {{amount}} vo {{member}} ablehne? S Mitglid wird benachrichtigt.',
  expensesEmpty: 'No kei Spese-Iireichige.',
  ...
  allInvoices: 'Rächnige',
  allInvoicesYear: 'Rächnige {{year}}',
  allInvoicesHint: 'Alli Rächnige vo de gwählte Saison — die wo da erstellt worde sind und die wo z Nacht us ClubDesk gspieglet werded.',
  noInvoicesInYear: 'Nonig Rächnige i de {{year}}.',
  invoiceSearchPlaceholder: 'Nach Nummere, Name, E-Mail oder Betreff sueche…',
  invoiceShowingCap: 'Es zeigt {{shown}} vo {{total}} — Sueche verfeinere für meh.',
  colCreatedBy: 'Erstellt vo',
  sourceNative: 'Wiedisync',
  sourceClubdesk: 'ClubDesk',
  nativeCount: '{{n}} us Wiedisync',
  clubdeskNoAuthor: 'De ClubDesk-Export het kei Urheberin/kein Urheber dinn — nu s Erstelligsdatum vo de Rächnig.',
  notLinked: 'Kem Mitglied zuegordnet',
  showAllYears: 'Alli Saisons',
  colNumber: 'Nr.',
  ...
  statusIssued: 'Gstellt',
  statusWrittenOff: 'Abgschribe',
  statusPaidPartlyWrittenOff: 'Zahlt (teilwiis abgschribe)',
  setAsPaid: 'As zahlt markiere',
  ...
  reportPaidDone: 'As zahlt markiert — Bestätigung staht uss.',
  reportPaidFailed: 'Het nöd chöne erfasst wärde. Lad d Siite bitte neu und probier s nomal.',
  newsTitle_one: 'Du hesch e offni Rächnig über {{amount}}',
  newsTitle_other: 'Du hesch {{count}} offni Rächnige über total {{amount}}',
  newsHint: 'Tipp, zum mit TWINT oder dinere Banking-App zahle',
  newsDue: 'Fällig {{date}}',
  newsOverdue: 'Überfällig',
  billedToTeam: 'Team {{team}}',
  orphanedInvoices: 'Nöd zuegordneti Rächnige',
  orphanedInvoicesYear: 'Nöd zuegordneti Rächnige {{year}}',
  noOrphansInYear: 'Alli Rächnige vo {{year}} sind eme Mitglied zuegordnet.',
  ...
  teamFinanceRefereeTitle: 'Schiedsrichterspese pro Heimspiel',
  refereeRecord: 'Erfasse',
  refereeEdit: 'Bearbeite',
  refereeNotRecorded: 'No nöd erfasst',
