export default {
  ...
  reason_teamRoleBias: '{{team}} Dienscht-Uusglich ({{points}})',
  ...
  reason_cannotFieldCrew: 'Cha {{seats}} Offiziell nöd stelle ({{row}})',
  reason_otr2Depth: 'OTR2-Reserve verfüegbar (+{{points}})',
  noTableRequired: 'Kes Tischpersonal nötig',
  ...
  ruleVbSoftLegends: 'Legends weg vom Schriiber, hin zu Täfeler/kombiniert (frei für D1/HU23): ±6',
