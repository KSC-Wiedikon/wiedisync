export default {
  ...
  refereeExpensesReimbursed: 'Vom Verein zruggzahlt — nüme bearbeitbar.',
  ...
  pregameRolePhysio: 'Physio',
  pregameRoleDoctor: 'Arzt/Ärztin',
  pregameRoleUnassigned: 'Rolle wähle',
  pregameAddOfficial: 'Offizielli Person hinzuefüege',
  pregameOfficialSearch: 'Vereinsmitglied sueche…',
  pregameOfficialNoResults: 'Kei Vereinsmitglied gfunde.',
  pregameRemoveOfficial: 'Offizielli Person entferne',
  ...
  recordingsNone: "No kei Ufnahme",
  recordingsUrl: "Video-URL",
  recordingsTitle: "Titel",
  recordingsTitlePlaceholder: "Titel (optional), z. B. Satz 1 oder Livestream",
  recordingsRemove: "Entferne",
  recordingsShowOnWebsite: "Uf de Website aazeige",
  recordingsOnWebsite: "Wird au uf kscw.ch aazeigt",
  recordingsWebsiteBadge: "Website",
  recordingsHint: "Links ohni «Uf de Website aazeige» gsehsch nur in Wiedisync.",
  recordingsSave: "Speichere",
  recordingsCancel: "Abbräche",
  recordingsSaved: "Ufnahme gspeicheret",
  recordingsSaveFailed: "Ufnahme händ nöd chöne gspeicheret werde",
  recordingsInvalidUrl: "Jede Link muess mit https:// aafange",
} as const
