export default {
  ...
  dhProposalHint: 'Sync down no longer writes to the database on its own. Accept to take ClubDesk\'s value, refuse to keep ours and queue a correction back to ClubDesk.',
  ...
  dhProposalColOurs: 'Ours',
  dhProposalColClubdesk: 'ClubDesk',
  dhProposalColWhy: 'Why',
  dhProposalColAction: 'Decision',
  dhProposalAccept: 'Accept',
  dhProposalRefuse: 'Refuse',
  dhProposalAcceptN: 'Accept {{count}}',
  dhProposalRefuseN: 'Refuse {{count}}',
  ...
  dhProposalEmailWarning: 'Accepting changes the login address',
  dhProposalEmailConfirmTitle: 'This changes a login address',
  dhProposalEmailConfirm_one: 'Accepting will change where {{names}} signs in. Their old address stops working. Continue?',
  dhProposalEmailConfirm_other: 'Accepting will change where {{count}} members sign in ({{names}}). Their old addresses stop working. Continue?',
  dhProposalNewMember: 'New member',
  dhProposalAccepted: '{{count}} accepted.',
  dhProposalRefused: '{{count}} refused.',
  ...
  explorerBulkDepartWarning: 'This sets the membership status and the exit date, and switches off club membership and app access. The status and the date are pushed into the ClubDesk member register at the next approved sync-up.',
  ...
  explorerBulkDepartConfirmMessage_one: '{{count}} member is set to "{{status}}" with exit date {{date}}, and loses club membership and app access. It cannot be undone.',
  explorerBulkDepartConfirmMessage_other: '{{count}} members are set to "{{status}}" with exit date {{date}}, and lose club membership and app access. It cannot be undone.',
