export default {
  ...
  federationOfOriginNone: 'None / never licensed abroad',
  federationOfOriginHint: 'The national federation you were last licensed with — needed to request a transfer certificate.',
