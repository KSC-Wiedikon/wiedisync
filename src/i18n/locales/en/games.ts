export default {
  ...
  pregameRolePhysio: 'Physiotherapist',
  pregameRoleDoctor: 'Medical doctor',
  pregameRoleUnassigned: 'Choose a role',
  pregameAddOfficial: 'Add an official',
  pregameOfficialSearch: 'Search club members to add…',
  pregameOfficialNoResults: 'No club member found.',
  pregameRemoveOfficial: 'Remove official',
  ...
  recordingsNone: "No recordings yet",
  recordingsUrl: "Video URL",
  recordingsTitle: "Title",
  recordingsTitlePlaceholder: "Title (optional), e.g. Set 1 or Livestream",
  recordingsRemove: "Remove",
  recordingsShowOnWebsite: "Show on website",
  recordingsOnWebsite: "Also shown on kscw.ch",
  recordingsWebsiteBadge: "Website",
  recordingsHint: "Links without \"Show on website\" are only visible in Wiedisync.",
  recordingsSave: "Save",
  recordingsCancel: "Cancel",
  recordingsSaved: "Recordings saved",
  recordingsSaveFailed: "Could not save the recordings",
  recordingsInvalidUrl: "Every link must start with https://",
} as const
