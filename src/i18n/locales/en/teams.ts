export default {
  ...
  shellInfoAction: 'Tell them to go to wiedisync.kscw.ch/signup and enter their email to set a password themselves. As soon as they log in for the first time, the temporary status clears automatically. Coaches can also extend the expiry date.',
  extend: 'Extend',
  // Feature toggles
