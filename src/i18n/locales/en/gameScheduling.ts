export default {
  ...
  mailboxGroup_qual_scorer_vb: 'Scorers',
  mailboxGroup_qual_referee_vb: 'Referees (volleyball)',
  mailboxGroup_qual_referee_bb: 'Referees (basketball)',
  mailboxGroup_qual_officials_bb: 'Officials (basketball)',
