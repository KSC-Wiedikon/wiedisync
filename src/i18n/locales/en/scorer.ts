export default {
  ...
  confirmSelfAssignArrival_bb: 'You must be in the hall at least <strong>20 minutes</strong> before the start of play.',
  ...
  infoArrivalBb: "The scorer, the timekeeper and the 24\" official must be in the hall at least <strong>20 minutes</strong> before the start of play.",
