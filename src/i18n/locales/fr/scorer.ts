export default {
  ...
  confirmSelfAssignArrival_bb: 'Vous devez etre dans la salle au moins <strong>20 minutes</strong> avant le debut du match.',
  ...
  infoArrivalBb: "Le marqueur, le chronométreur et l'officiel 24\" doivent être dans la salle au moins <strong>20 minutes</strong> avant le début du match.",
