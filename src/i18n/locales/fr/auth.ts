export default {
  ...
  resetLinkDescription: 'Saisissez votre adresse e-mail et nous vous enverrons un lien pour choisir un nouveau mot de passe.',
  resetLinkButton: 'Envoyer le lien',
  resetLinkSending: 'Envoi du lien...',
  resetLinkSentTitle: 'Consultez vos e-mails',
  resetLinkSentInfo: 'Si un compte existe pour {{email}}, nous avons envoyé un lien pour choisir un nouveau mot de passe. Le lien est valable une heure.',
  resetLinkFailed: 'Le lien n\'a pas pu être envoyé. Veuillez réessayer.',
  resetUseCodeInstead: 'Jamais défini de mot de passe ? Utilisez plutôt un code',
  ...
  federationOfOriginHint: "La fédération nationale qui vous a licencié en premier. S’il s’agit de votre toute première licence, choisissez la Suisse — Swiss Volley ou Swiss Basketball devient alors votre fédération d’origine.",
  nationalitaetHint: 'Plusieurs choix possibles.',
  trainerLicences: 'Formation d\'entraîneur',
  trainerLicencesHint: 'Plusieurs choix possibles — J+S est indépendant des niveaux d\'entraîneur.',
  trainerLicenceJS: 'J+S',
  trainerLicenceC: 'Entraîneur C',
  trainerLicenceB: 'Entraîneur B',
  trainerLicenceA: 'Entraîneur A',
  trainerLicenceT1: 'Entraîneur 1',
  trainerLicenceT2: 'Entraîneur 2',
  trainerLicenceT3: 'Entraîneur 3',
  sex: 'Sexe',
  ...
  idGapTitle_one: '{{count}} responsable d\'équipe ne peut pas encore ouvrir votre pièce d\'identité',
  idGapTitle_other: '{{count}} responsables d\'équipe ne peuvent pas encore ouvrir votre pièce d\'identité',
  idGapHint: '{{names}} a rejoint l\'encadrement de votre équipe après votre téléversement. Accordez l\'accès pour corriger cela — votre document n\'est pas téléversé à nouveau et personne d\'autre n\'obtient l\'accès.',
  idGrant: 'Accorder l\'accès',
  idGranted_one: 'Accès accordé à {{count}} responsable d\'équipe.',
  idGranted_other: 'Accès accordé à {{count}} responsables d\'équipe.',
  idGrantFailed: 'L\'accès n\'a pas pu être accordé.',
  ...
  // Recadrer / pivoter avant le chiffrement
  idCropTitle: 'Ajuster votre document',
  idCropHint: 'Faites glisser pour déplacer, pincez ou utilisez le curseur pour zoomer, et pivotez si nécessaire.',
  idCropZoom: 'Zoom',
  idCropRotateLeft: 'Pivoter à gauche',
  idCropRotateRight: 'Pivoter à droite',
  idCropShape: 'Format du document',
  idCropAspect_card: 'Carte d\'identité',
  idCropAspect_landscape: 'Paysage',
  idCropAspect_portrait: 'Portrait',
  idCropCancel: 'Annuler',
  idCropConfirm: 'Utiliser cette photo',
  idCropFailed: 'L\'image n\'a pas pu être traitée. Veuillez essayer une autre photo.',
  ...
  licenceStatusTitle: 'Statut de licence',
  licenceStatusHelp: 'Défini par le club et confirmé par ta fédération. Contacte ton entraîneur si quelque chose ne va pas.',
} as const
