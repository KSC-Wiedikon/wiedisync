export default {
  ...
  federationOfOriginNone: "Aucune / jamais licencié à l'étranger",
  federationOfOriginHint: "La fédération nationale auprès de laquelle vous étiez licencié en dernier — nécessaire pour le certificat de transfert.",
