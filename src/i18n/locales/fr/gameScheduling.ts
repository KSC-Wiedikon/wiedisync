export default {
  ...
  mailboxGroupPlaceholder: 'Choisir un groupe…',
  mailboxGroupTeams: 'Équipes',
  ...
  mailboxGroup_all: 'Tous les membres',
  mailboxGroup_sport_volleyball: 'Tout le volleyball',
  mailboxGroup_sport_basketball: 'Tout le basketball',
  mailboxGroup_fn_coach: 'Tous les entraîneurs',
  mailboxGroup_fn_team_responsible: 'Tous les responsables d’équipe',
  mailboxGroup_fn_captain: 'Tous les capitaines',
  mailboxGroup_qual_scorer_vb: 'Tous les marqueurs',
  mailboxGroup_qual_referee_vb: 'Tous les arbitres (volleyball)',
  mailboxGroup_qual_referee_bb: 'Tous les arbitres (basketball)',
  mailboxGroup_qual_officials_bb: 'Tous les officiels (basketball)',
  ...
  mailboxDownloadFailed: 'Échec du téléchargement',
