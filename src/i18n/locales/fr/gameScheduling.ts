export default {
  ...
  inviteContactHint: 'Cette invitation a été envoyée à {{email}}. Pas la bonne personne ? Merci de la transférer à la personne responsable de la planification dans votre club, ou écrivez à',
