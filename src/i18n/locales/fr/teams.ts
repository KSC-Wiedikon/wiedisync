export default {
  ...
  identityCol: 'ID',
  identityAccessButton: 'Accès aux documents',
  identityAccessTitle: 'Qui peut ouvrir ces documents',
  identityAccessHint: 'Les pièces d\'identité sont chiffrées pour des lecteurs nommés. Faire partie d\'une équipe ne donne pas l\'accès en soi — une clé est enregistrée pour chaque lecteur au moment du téléversement. Qui a créé sa clé d\'identité plus tard n\'en possède aucune tant que l\'accès n\'est pas rétabli.',
  identityAccessEmpty: 'Personne dans cette équipe n\'a encore téléversé de document.',
  identityAccessPlayer: 'Personne',
  identityAccessUploaded: 'Téléversé',
  identityAccessReaders: 'Peut l\'ouvrir',
  identityAccessOwner: 'propriétaire',
  identityState_holds: 'Peut ouvrir',
  identityState_stale: 'Ne s\'ouvrira pas',
  identityState_missing: 'Pas encore de clé',
  identityState_no_key: 'Aucune clé d\'identité créée',
  identityState_former: 'Ancien encadrement, a encore accès',
  identityRepairTitle_one: '{{names}} ne peut pas ouvrir {{count}} pièce d\'identité de cette équipe',
  identityRepairTitle_other: '{{names}} ne peut pas ouvrir {{count}} pièces d\'identité de cette équipe',
  identityRepairHint: 'La clé d\'identité a été créée après ces téléversements, aucune clé n\'a donc jamais été enregistrée. Vous pouvez rétablir l\'accès ici — les documents ne sont pas téléversés à nouveau et personne en dehors de l\'encadrement de l\'équipe n\'obtient l\'accès.',
  identityRepairAction: 'Rétablir l\'accès',
  identityRepairUnlock: 'Déverrouillez votre clé d\'identité dans votre profil pour rétablir l\'accès',
  identityRepairDone_one: 'Accès rétabli pour {{count}} document.',
  identityRepairDone_other: 'Accès rétabli pour {{count}} documents.',
  identityRepairPartial_one: '{{count}} document n\'a pas pu être réparé.',
  identityRepairPartial_other: '{{count}} documents n\'ont pas pu être réparés.',
