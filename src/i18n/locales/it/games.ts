export default {
  ...
  pregameRolePhysio: 'Fisioterapista',
  pregameRoleDoctor: 'Medico',
  pregameRoleUnassigned: 'Scegli un ruolo',
  pregameAddOfficial: 'Aggiungi un ufficiale',
  pregameOfficialSearch: 'Cerca un membro del club…',
  pregameOfficialNoResults: 'Nessun membro del club trovato.',
  pregameRemoveOfficial: "Rimuovi l'ufficiale",
  ...
  recordingsNone: "Nessuna registrazione",
  recordingsUrl: "URL del video",
  recordingsTitle: "Titolo",
  recordingsTitlePlaceholder: "Titolo (facoltativo), es. Set 1 o Livestream",
  recordingsRemove: "Rimuovi",
  recordingsShowOnWebsite: "Mostra sul sito web",
  recordingsOnWebsite: "Mostrato anche su kscw.ch",
  recordingsWebsiteBadge: "Sito web",
  recordingsHint: "I link senza «Mostra sul sito web» sono visibili solo in Wiedisync.",
  recordingsSave: "Salva",
  recordingsCancel: "Annulla",
  recordingsSaved: "Registrazioni salvate",
  recordingsSaveFailed: "Impossibile salvare le registrazioni",
  recordingsInvalidUrl: "Ogni link deve iniziare con https://",
} as const
