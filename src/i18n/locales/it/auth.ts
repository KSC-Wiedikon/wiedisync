export default {
  ...
  federationOfOriginNone: "Nessuna / mai tesserato all'estero",
  federationOfOriginHint: 'La federazione nazionale presso cui eri tesserato per ultimo — necessaria per il certificato di trasferimento.',
