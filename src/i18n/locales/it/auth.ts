export default {
  ...
  preparingPhoto: 'Preparazione della foto…',
  ...
  federationOfOriginHint: 'La federazione nazionale che ti ha tesserato per prima. Se è il tuo primo tesseramento in assoluto, scegli la Svizzera — Swiss Volley o Swiss Basketball diventa la tua federazione di origine.',
  ...
  idGapTitle_one: '{{count}} responsabile di squadra non può ancora aprire il tuo documento',
  idGapTitle_other: '{{count}} responsabili di squadra non possono ancora aprire il tuo documento',
  idGapHint: '{{names}} è entrato nello staff della tua squadra dopo il tuo caricamento. Concedi l\'accesso per risolvere — il documento non viene ricaricato e nessun altro ottiene l\'accesso.',
  idGrant: 'Concedi l\'accesso',
  idGranted_one: 'Accesso concesso a {{count}} responsabile di squadra.',
  idGranted_other: 'Accesso concesso a {{count}} responsabili di squadra.',
  idGrantFailed: 'Impossibile concedere l\'accesso.',
