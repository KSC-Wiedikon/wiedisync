export default {
  ...
  confirmSelfAssignArrival_bb: 'Devi essere in palestra almeno <strong>20 minuti</strong> prima dell\'inizio del gioco.',
  ...
  infoArrivalBb: "Il segnapunti, il cronometrista e l'ufficiale 24\" devono essere in palestra almeno <strong>20 minuti</strong> prima dell'inizio del gioco.",
