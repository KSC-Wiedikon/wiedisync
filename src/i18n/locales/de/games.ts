export default {
  ...
  pregameRolePhysio: 'Physiotherapeut/in',
  pregameRoleDoctor: 'Arzt/Ärztin',
  pregameRoleUnassigned: 'Rolle wählen',
  pregameAddOfficial: 'Offizielle Person hinzufügen',
  pregameOfficialSearch: 'Vereinsmitglied suchen…',
  pregameOfficialNoResults: 'Kein Vereinsmitglied gefunden.',
  pregameRemoveOfficial: 'Offizielle Person entfernen',
  ...
  recordingsLivestreamHint: "Ein Livestream-Link mit «Auf der Website anzeigen» wird auf kscw.ch hervorgehoben, bis das Spiel gespielt ist – danach bleibt er als Aufzeichnung.",
  recordingsAdd: "Video hinzufügen",
  recordingsEdit: "Bearbeiten",
  recordingsAddAnother: "Weiteren Link hinzufügen",
  recordingsNone: "Noch keine Aufnahmen",
  recordingsUrl: "Video-URL",
  recordingsTitle: "Titel",
  recordingsTitlePlaceholder: "Titel (optional), z. B. Satz 1 oder Livestream",
  recordingsRemove: "Entfernen",
  recordingsShowOnWebsite: "Auf der Website anzeigen",
  recordingsOnWebsite: "Wird auch auf kscw.ch angezeigt",
  recordingsWebsiteBadge: "Website",
  recordingsHint: "Links ohne «Auf der Website anzeigen» sind nur in Wiedisync sichtbar.",
  recordingsSave: "Speichern",
  recordingsCancel: "Abbrechen",
  recordingsSaved: "Aufnahmen gespeichert",
  recordingsSaveFailed: "Aufnahmen konnten nicht gespeichert werden",
  recordingsInvalidUrl: "Jeder Link muss mit https:// beginnen",
} as const
