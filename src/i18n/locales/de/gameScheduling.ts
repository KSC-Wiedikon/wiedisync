export default {
  ...
  inviteContactHint: 'Diese Einladung wurde an {{email}} geschickt. Falsche Person? Bitte leite sie an die für die Spielplanung zuständige Person in deinem Verein weiter, oder schreib an',
