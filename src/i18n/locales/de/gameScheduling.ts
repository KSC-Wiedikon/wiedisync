export default {
  ...
  mailboxGroupPlaceholder: 'Gruppe wählen…',
  ...
  mailboxGroup_all: 'Alle Mitglieder',
  mailboxGroup_sport_volleyball: 'Alle Volleyball',
  mailboxGroup_sport_basketball: 'Alle Basketball',
  mailboxGroup_fn_coach: 'Alle Trainer*innen',
  mailboxGroup_fn_team_responsible: 'Alle Teamverantwortlichen',
  mailboxGroup_fn_captain: 'Alle Captains',
  mailboxGroup_qual_scorer_vb: 'Alle Schreiber*innen',
  mailboxGroup_qual_referee_vb: 'Alle Schiedsrichter*innen (Volleyball)',
  mailboxGroup_qual_referee_bb: 'Alle Schiedsrichter*innen (Basketball)',
  mailboxGroup_qual_officials_bb: 'Alle Offiziellen (Basketball)',
  ...
  mailboxDownloadFailed: 'Download fehlgeschlagen',
