export default {
  ...
  mailboxGroup_qual_scorer_vb: 'Schreiber*innen',
  mailboxGroup_qual_referee_vb: 'Schiedsrichter*innen (Volleyball)',
  mailboxGroup_qual_referee_bb: 'Schiedsrichter*innen (Basketball)',
