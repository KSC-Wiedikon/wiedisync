export default {
  ...
  subtitleBb: "Tischoffizielle (Anschreiber, Zeitnehmer, 24s) für Basketball-Heimspiele.",

  // Tabs
  tabGames: 'Spiele',
  tabOverview: 'Übersicht',
  dutyScopeAll: 'Alle',
  dutyScopeMine: 'Meine Einsätze',
  ...
  confirmSelfAssignArrival_bb: 'Du musst spätestens <strong>20 Minuten</strong> vor Spielbeginn in der Halle sein.',
  ...
  infoArrivalBb: "Anschreiber/in, Zeitnehmer/in und 24s müssen spätestens <strong>20 Minuten</strong> vor Spielbeginn in der Halle sein.",
  infoLicencesTitleBb: "Lizenzen",
  infoLicencesBb: "Anschreiber/in und Zeitnehmer/in brauchen OTR1 oder höher (OTR2, OTN). Der 24s-Platz braucht OTR2 oder OTN. Du kannst dich nur für einen Platz eintragen, den deine Lizenz abdeckt.",
