export default {
  ...
  shellInfoAction: 'Sag dem Mitglied, es soll auf wiedisync.kscw.ch/signup gehen und die E-Mail-Adresse eingeben, um selbst ein Passwort zu setzen. Sobald es sich zum ersten Mal einloggt, verschwindet der Temporär-Status automatisch. Coaches können das Ablaufdatum auch verlängern.',
  // Feature-Toggles
