export default {
  ...
  resetLinkDescription: 'Gib deine E-Mail-Adresse ein und wir senden dir einen Link, um ein neues Passwort zu wählen.',
  resetLinkButton: 'Link senden',
  resetLinkSending: 'Link wird gesendet...',
  resetLinkSentTitle: 'Prüfe deine E-Mails',
  resetLinkSentInfo: 'Falls ein Konto für {{email}} existiert, haben wir einen Link zum Setzen eines neuen Passworts gesendet. Der Link ist eine Stunde gültig.',
  resetLinkFailed: 'Der Link konnte nicht gesendet werden. Bitte versuche es erneut.',
  resetUseCodeInstead: 'Noch nie ein Passwort gesetzt? Nutze stattdessen einen Code',
  ...
  kantonsschuleHint: 'An welcher Zürcher Kantonsschule du bist. Der Club wird nach diesen Zahlen gefragt.',
  kantonsschuleUnset: '— Nicht beantwortet',
  kantonsschuleNo: 'Nein — ich bin an keiner Kantonsschule',
  kantonsschuleSearch: 'Schulen suchen…',
  ...
  idGapTitle_one: '{{count}} Teamleitung kann deine ID noch nicht öffnen',
  idGapTitle_other: '{{count}} Personen der Teamleitung können deine ID noch nicht öffnen',
  idGapHint: '{{names}} kam erst nach deinem Upload zur Teamleitung dazu. Mit «Zugriff erteilen» wird das behoben — dein Dokument wird nicht neu hochgeladen und niemand sonst erhält Zugriff.',
  idGrant: 'Zugriff erteilen',
  idGranted_one: 'Zugriff für {{count}} Teamleitung erteilt.',
  idGranted_other: 'Zugriff für {{count}} Personen der Teamleitung erteilt.',
  idGrantFailed: 'Der Zugriff konnte nicht erteilt werden.',
