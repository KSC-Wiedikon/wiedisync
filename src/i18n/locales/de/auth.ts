export default {
  ...
  federationOfOriginHint: 'Der nationale Verband, der dich zuerst lizenziert hat. Ist dies deine allererste Lizenz, wähle die Schweiz — dann ist Swiss Volley bzw. Swiss Basketball dein Herkunftsverband.',
