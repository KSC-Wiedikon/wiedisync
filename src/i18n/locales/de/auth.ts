export default {
  ...
  federationOfOriginNone: 'Keiner / nie im Ausland lizenziert',
  federationOfOriginHint: 'Der nationale Verband, bei dem du zuletzt lizenziert warst — nötig für die Spielberechtigung.',
