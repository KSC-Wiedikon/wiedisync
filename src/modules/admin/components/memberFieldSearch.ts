...
const ALIASES: Readonly<Record<string, string>> = {
  ...
  dues_paid: 'bezahlt paid rechnung invoice mitgliederbeitrag beitrag dues bill',
  dues_paid_season: 'bezahlt paid saison season mitgliederbeitrag',
  dues_paid_at: 'bezahlt paid datum date mitgliederbeitrag abgeschlossen',
