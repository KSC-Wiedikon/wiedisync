...
const fixtures = () => ({
  events: [
    { id: 10, title: 'Sommerfest', event_type: 'social', start_date: '2026-08-01T16:00:00Z', end_date: null, all_day: false, location: 'KWI', description: 'Alle willkommen', signup_url: null, cancelled: false, cancel_reason: null },
    { id: 11, title: 'H3 Turnier', event_type: 'tournament', start_date: '2026-08-08T10:00:00Z', end_date: null, all_day: false, location: null, description: null, signup_url: null, cancelled: false, cancel_reason: null },
    { id: 12, title: 'Herbstfest', event_type: 'social', start_date: '2026-09-05T14:00:00Z', end_date: null, all_day: false, location: null, description: null, signup_url: null, cancelled: true, cancel_reason: 'Halle gesperrt' },
    { id: 13, title: 'Einzeltermin', event_type: 'other', start_date: '2026-09-12T09:00:00Z', end_date: null, all_day: false, location: null, description: null, signup_url: null, cancelled: false, cancel_reason: null },
    { id: 14, title: 'Generalversammlung', event_type: 'meeting', start_date: '2026-10-01T18:00:00Z', end_date: null, all_day: false, location: null, description: null, signup_url: null, cancelled: false, cancel_reason: null },
  ],
...
describe('GET /public/events', () => {
  it('junction rows with NULL events_id do not hide club-wide events (EVT-01)', async () => {
    ...
    expect(res.body.data.map((e) => e.id)).toEqual([10, 14])
  })
