...
Older entries moved out of the main [CHANGELOG.md](CHANGELOG.md) to keep it lean. Newest-first, same format. The in-app "What's New" (`src/modules/changelog/ChangelogPage.tsx`) remains the user-facing record.
